...
@WebServlet(name = "ServletReceive", urlPatterns = {"/show"})
...
//                String myDate1[] = myDate.split(" ");
                ...
                //int x = Integer.parseInt(ResultSet)
                //sampleData[ii]=Integer.parseInt(tripTime);
                //ii++;
                //JSONObject obj = new JSONObject();
                //obj.put("tripTime",resultSet.getString(4));
                //jarry.put(obj);

                //obj.put("triptime",arrli.get(3));
...
//                out.print("</table>\n");
               ...
               // out.print("{ y: " + arrli.get(i) + ", label: \"UNIT NO.\" },\n" + "");
                //request.setAttribute("triptime",(arrli.get(i)).toString());
            //obj.put("trips",jarry);

            //request.getSession.se("ServletReceive","bobs burgers");

//            request.getSession().setAttribute("ServletReceive",jarry.toString());
...
//            pw.close();
            request.getSession().setAttribute("jsonArray",array.toString());
            request.getRequestDispatcher("/index.jsp").forward(request,response);
